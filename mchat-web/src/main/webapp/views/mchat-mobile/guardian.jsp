...
<link rel="stylesheet" type="text/css" href="../../mobile/js/mdialog.css?v=1">
<style>
.gif{
		width:90%;
		height:90%;
      ...
      <div class="m_list_1 b_solid m_top_20 ${report.sexShow ? '' : 'divhide'}">
        ...
        <p>
			<select name="sex" id="sex" class="fs"}>
			    ...
			    <option value="1" ${report.sex eq '1' ? "selected = 'selected'" : ""}>男</option>
				<option value="0" ${report.sex eq '0' ? "selected = 'selected'" : ""}>女</option>
			</select>
		</p>
      </div>  
...
<div style=" position:absolute; display:none; top:0;z-index:999; background-color:#FFF; height:100%" class="p_read">
    ...
    <strong><span style="font-size:16px;">一、什么是M-CHAT-R/F筛查量表？</span></strong><br />
    <p>
    ...
    <strong><span style="font-size:16px;">M-CHAT-R/F一共有两部分组成：</span></strong><br />
