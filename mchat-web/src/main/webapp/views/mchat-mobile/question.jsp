...
<link rel="Stylesheet" type="text/css" href="../../mobile/css/style.css?v=2" />
<link rel="Stylesheet" type="text/css" href="../../mobile/css/m_2.css?v=3" />
...
<body>
	...
	<div id="contentDiv">
	    ...
	    <div id="m_test_name" style="text-align:right;">
	    	<div style="width:248px;height:22px;margin: 0 auto;">
                <ul class="q_ul">
                    <li value="1">1</li>
                    <li value="2">2</li>
                    <li value="3">3</li>
	    ...
	    <div class="m_mid">
	        <div class="m_question">
	            <p id="question" style="font-size:14px;">1、如果您指向房间内的某样东西，孩子会看它吗？（例如，您指着一个玩具或一只动物，孩子会看这个玩具或这只动物吗？）</p>
	        </div>
                ...
                $.ajax({
                	...
                	success : function(msg){
                		if(msg!=null&&msg.code==1){
                			window.location.href =  util.requestURL+"/mobile/html/success.html";
                		}else{
                			new TipBox({
                				type:"error",
                				str:msg.msg,
